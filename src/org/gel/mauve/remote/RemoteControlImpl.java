...
public class RemoteControlImpl extends UnicastRemoteObject implements RemoteControl
{
    ...
    public void setFocus(String alignID, String sequenceID, long start, long end, String auth_token) throws RemoteException
    {
        app.setFocus(alignID, sequenceID, start, end, auth_token);
    }
    ...
    public static void startRemote(Mauve app)
    {
        try
        {
            Registry r = LocateRegistry.createRegistry(RemoteApplet.REMOTE_PORT);
