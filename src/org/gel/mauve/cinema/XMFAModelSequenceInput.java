...
public class XMFAModelSequenceInput extends CinemaGuiModule implements
	...
	public SequenceAlignment openAlignment (XmfaViewerModel model, int ordinal) {
		...
		SimpleIdentifier identifier = new SimpleIdentifier (source.getTitle (),
				source);
		try {
			SequenceAlignment sa = parser.parse (identifier, new FileReader (
					file), this);
