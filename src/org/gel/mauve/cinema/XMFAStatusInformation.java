...
public class XMFAStatusInformation extends CinemaGuiModule implements PropertyChangeListener
{
  public void start()
  {
  ...
  private void printCursorInfo()
  {
    ...
    GappedSequence seq = getSequenceAlignment().getSequenceAt(point.getY());
    XMFASequenceIdentifier ident = (XMFASequenceIdentifier) seq.getIdentifier();
    ...
    {
        sendStatusMessage( ident.getTitle() + " @ " + (seq.getUngappedPositionOf(point.getX()) + ident.getRange()[0] - 1) );
    }
  }
