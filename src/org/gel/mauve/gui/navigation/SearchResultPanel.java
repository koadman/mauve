...
/**
 * A Gui component that shows the results of a given query
 * 
 * @author rissman
 *
 */
public class SearchResultPanel extends JPanel implements TreeModel, TreeCellRenderer,
	 ...
	 * 1 if there is 1 result, any number higher than 1 means multiple results
	 */
	...
	/**
	 * used to display whether tree node has children or not
	 */
	 ...
	 * 
	 * @param genomes	The genomes that the mauve frame displays
	 ...
	 * 
	 * @param data		An array of linked lists.  Each list should start
	 * 					with a genome object, followed by all the Features
	 * 					to display in that genome
	 */
	 ...
	 * 
	 *@param data		The data that should be added.  Each array index is a linked
	 *					list containing first the genome it is for, then all the features
	 *					to display for that sequence
	 */
	protected void resetData (Object [] data) {
		...
		if (result_state != 0 && navigator.shouldClear ()) {
			...
			while (keys.hasMoreElements()) {
				LinkedList remove = (LinkedList) genome_data.get (keys.nextElement());
				remove.clear ();
			}
			result_state = 0;
		}
	 ...
	 * 
	 * @param feat		The feature whose information should be displayed
	...
	public Component getTreeCellRendererComponent(JTree tree, Object val, boolean selected,
		...
		JLabel label = (JLabel) renderer.getTreeCellRendererComponent(tree, val, selected,
	 ...
	 * 
	 * @param parent		The object whose child should be found
	 ...
	 * 
	 * @param parent		The object representing the parent
	 ...
	 * 
	 * @param parent		The parent of the child in question
	 ...
	 * 
	 * @param node		The object in question
	...
	/**
	 * represents an icon that shows whether a given node can be expanded (has children)
	 * 
	 * @author rissman
	 *
	 */
	public static class SignedIcon implements Icon {
		 ...
		 * 
		 * @param p		Whether it should show a plus or minus
		 */
		 ...
		 * 
		 * @param plus		True if the icon should show a plus sign,
		 * 					false if it should show a minus sign
		 * @return			
		 */
