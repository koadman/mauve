 ...
 */
public class MauvePanel extends JPanel implements ActionListener, ModelProgressListener
{
    protected BaseViewerModel model;
    
    //if contained in a top-level component, here's the reference
    //for now, if set, is MauveFrame
    ...
    //TODO if not in parent window, should deal with close or quit operations
    //somewhere - anna
    public void setPanelCloseListener (Window window) {
        // event handling
    	parent = window;
...
//        jMenuBar1.add (jMenuGoTo);
        ...
        if (ae.getSource() instanceof JMenuItem)
        {
            ...
            if (source == jMenuHelpAbout || ae.getActionCommand().equals("About"))
            {
            	if (getTopLevelAncestor () instanceof Window)
            		new SplashScreen("/images/mauve_logo.png", Mauve.about_message, (Window) 
            				getTopLevelAncestor (), 5000000);
            }
    ...
    public void addNotify()
    {
        ...
        // not necessary due to change in layout manager
    ...
    void thisWindowClosing(java.awt.event.WindowEvent e)
    {
        ...
        if (parent != null) {
        	if (parent instanceof MauveFrame)
                mauve.closeFrame((MauveFrame) parent);
    ...
    public void setModel(BaseViewerModel model)
    {
        ...
        else
        {
            ...
            // TODO - commented this out; hope it's ok
